  ...
  return (
    <main className="p-3">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Kotolog, the software program provided by the
            Company.
          </p>
        </li>
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Kotolog.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By email: deplatnbx@gmail.com</li>
      </ul>
    </main>
  )
}
